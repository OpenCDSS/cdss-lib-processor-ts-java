#!/bin/bash
#
# This script removes the `org/w3c` classes from the `jython.jar` jar file
# and then creates a new jar file `jython-fixed.jar`.
# The resulting jar file should be used in Eclipse library dependency and the installer build.

tmpFolder="/tmp/fix-jython"
jarExe="/c/Program Files/java/jdk11/bin/jar"

# Script folder.
scriptFolder=$(cd $(dirname "$0") && pwd)
jarFile="${scriptFolder}/jython.jar"
newJarFile="${scriptFolder}/jython-fixed.jar"
...
# /tmp/fix-jython/META-INF/INDEX.LIST
