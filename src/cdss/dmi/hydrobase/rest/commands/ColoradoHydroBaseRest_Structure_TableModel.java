...
*/
public ColoradoHydroBaseRest_Structure_TableModel ( JWorksheet worksheet, int wdid_length, List data )
throws Exception
{
...
@throws Exception if an invalid results passed in.
*/
public ColoradoHydroBaseRest_Structure_TableModel ( JWorksheet worksheet, int wdid_length, List data, String inputType )
throws Exception
