// ReadTimeSeriesFromDataStore_JDialog - Editor for the ReadTimeSeriesFromDataStore() command.
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "ReadTimeSeriesFromDataStore");
	}
