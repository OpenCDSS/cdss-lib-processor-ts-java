// WriteTableToDataStore_Command - This class initializes, checks, and runs the WriteTableToDataStore() command.
...
{   String DataStore = parameters.getValue ( "DataStore" );
    ...
    validList.add ( "DataStoreRelatedColumnsMap" );
...
public boolean editCommand ( JFrame parent ) {
	...
	List<String> tableIDChoices =
        TSCommandProcessorUtil.getTableIdentifiersFromCommandsBeforeCommand(
            (TSCommandProcessor)getCommandProcessor(), this);
	return (new WriteTableToDataStore_JDialog ( parent, this, tableIDChoices, dataStoreList )).ok();
}
...
{	String routine = getClass().getSimpleName() + ".runCommand", message = "";
    ...
    try {
        ...
        List<String> datastoreTableColumns = new ArrayList<>();
        try {
