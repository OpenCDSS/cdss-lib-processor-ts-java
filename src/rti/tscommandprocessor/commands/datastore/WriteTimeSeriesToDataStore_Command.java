// WriteTimeSeriesToDataStore_Command - This class initializes, checks, and runs the WriteTimeSeriesToDataStore() command.
...
private String checkDataStoreProperty(DatabaseMetaData dbMeta, String tableName, String columnName, String propertyName,
    ...
    Object o = __dbMetaHashtable.get(key.toString());
    /*
    if ( o == null ) {
