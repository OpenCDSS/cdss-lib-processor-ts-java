// WriteTimeSeriesToDataStore_JDialog - editor dialog for the WriteTimeSeriesToDataStore() command.
...
{	Object o = event.getSource();
    ...
    if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "WriteTimeSeriesToDataStore");
	}
