// ----------------------------------------------------------------------------
// runDataTest_JDialog - editor for the "TestID x = runDataTest()" command.
// ----------------------------------------------------------------------------
...
/*
	...
	if (alias == null || alias.trim().equalsIgnoreCase("")) {
		if (((runDataTest_Command)command).getCommandString().trim()
...
private void checkInput () {
	String routine = "runDataTest_JDialog.checkInput";
	/*
...
/*
	...
	Vector v = new Vector();
	v.add("");
	v.add(runDataTest_Command._TRUE);
	v.add(runDataTest_Command._FALSE);
	...
	if (__isAliasVersion) {
		setTitle("Edit TS Alias = runDataTest() Command");
	}
	else {
		setTitle("Edit runDataTest() Command");
	}
...
/*
	String routine = "runDataTest_JDialog.refresh";
		...
		if (Read24HourAsDay != null) {
			if (Read24HourAsDay.equalsIgnoreCase("true")) {
				__Read24HourAsDay_JComboBox.select(
					runDataTest_Command._TRUE);
			}
			else if (Read24HourAsDay.equalsIgnoreCase("false")) {
				__Read24HourAsDay_JComboBox.select(
					runDataTest_Command._FALSE);
			}
			else {
				__Read24HourAsDay_JComboBox.select(0);
			}
