// WriteDelftFewsPiXml_Command - This class initializes, checks, and runs the WriteDelftFewsPiXml() command.
...
/**
This class initializes, checks, and runs the WriteDelftFewsPiXml() command.
*/
public class WriteDelftFewsPiXml_Command extends AbstractCommand implements Command, FileGenerator
{
...
Constructor.
*/
public WriteDelftFewsPiXml_Command ()
{	super();
	setCommandName ( "WriteDelftFewsPiXml" );
}
...
{	// The command will be modified if changed...
	return (new WriteDelftFewsPiXml_JDialog ( parent, this )).ok();
}
