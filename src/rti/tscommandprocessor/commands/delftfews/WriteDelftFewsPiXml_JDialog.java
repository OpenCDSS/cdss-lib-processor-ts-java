// WriteDelftFewsPiXml_JDialog - editor dialog for the WriteDelftFewsPiXml() command.
...
private WriteDelftFewsPiXml_Command __command = null;
...
*/
public WriteDelftFewsPiXml_JDialog (	JFrame parent, WriteDelftFewsPiXml_Command command )
{	super(parent, true);
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, WriteDelftFewsPiXml_Command command )
{	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"<html><b>This command is under development - it is being used to test output from the ReadDelftFewsPiXml() command.</b></html>" ),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Write time series to a DELFT FEWS PI XML format file," +
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "PI XML file to write:" ), 
