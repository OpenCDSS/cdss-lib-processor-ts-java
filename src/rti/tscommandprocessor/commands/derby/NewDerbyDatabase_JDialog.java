// NewDerbyDatabase_JDialog - editor for NewDerbyDatabase command
...
public class NewDerbyDatabase_JDialog extends JDialog
...
private JTextField __DatabaseDir_JTextField = null;
private SimpleJButton __browse_JButton = null;
private SimpleJButton __path_JButton = null;
private SimpleJButton __cancel_JButton = null;
private SimpleJButton __ok_JButton = null;
private SimpleJButton __help_JButton = null;
private NewDerbyDatabase_Command __command = null;
...
*/
public NewDerbyDatabase_JDialog ( JFrame parent, NewDerbyDatabase_Command command )
{	super(parent, true);
...
{	Object o = event.getSource();
    ...
    if ( o == __browse_JButton ) {
        ...
        fc.setDialogTitle( "Select Folder for Derby Database");
        ...
        if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            if (path != null) {
				...
				try {
					__DatabaseDir_JTextField.setText(IOUtil.toRelativePath(__working_dir, path));
				}
				catch ( Exception e ) {
					Message.printWarning ( 1,"NewDerbyDatabase_JDialog", "Error converting file to relative path." );
				}
		...
		HelpViewer.getInstance().showHelp("command", "NewDerbyDatabase");
	}
        ...
        if ( __path_JButton.getText().equals( __AddWorkingDirectory) ) {
            __DatabaseDir_JTextField.setText (
            IOUtil.toAbsolutePath(__working_dir, __DatabaseDir_JTextField.getText() ) );
        }
        else if ( __path_JButton.getText().equals( __RemoveWorkingDirectory) ) {
            try {
                __DatabaseDir_JTextField.setText (
                IOUtil.toRelativePath ( __working_dir, __DatabaseDir_JTextField.getText() ) );
            }
            catch ( Exception e ) {
...
{	// Put together a list of parameters to check...
    ...
    if ( DatabaseDir.length() > 0 ) {
        props.set ( "DatabaseDir", DatabaseDir );
    }
	try {
...
{	String DataStore = __DataStore_JTextField.getText().trim();
    ...
    __command.setCommandParameter ( "DatabaseDir", DatabaseDir );
}
...
*/
private void initialize ( JFrame parent, NewDerbyDatabase_Command command )
{	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Database directory:" ), 
        0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
...
{	//String routine = getClass().getSimpleName() + ".refresh";
	...
	if (__first_time) {
		...
		DatabaseDir = props.getValue ( "DatabaseDir" );
        if ( DataStore != null ) {
            __DataStore_JTextField.setText ( DataStore );
        }
        if ( DatabaseDir != null ) {
            __DatabaseDir_JTextField.setText ( DatabaseDir );
        }
	}
	// Regardless, reset the command from the fields...
	DataStore = __DataStore_JTextField.getText().trim();
	DatabaseDir = __DatabaseDir_JTextField.getText().trim();
