// CreateEnsembleFromOneTimeSeries_JDialog - Command editor dialog for the CreateEnsembleFromOneTimeSeries() command.
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "CreateEnsembleFromOneTimeSeries");
	}
