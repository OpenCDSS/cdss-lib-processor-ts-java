...
private NewStatisticTimeSeriesFromEnsemble_Command __command = null;	// Command to edit.
private JTextArea	__command_JTextArea=null;// Command as JTextField
private JTextField	__Alias_JTextField = null;// Field for time series alias
private SimpleJComboBox	__EnsembleID_JComboBox = null;// Time series available to
						// operate on.
...
*/
public NewStatisticTimeSeriesFromEnsemble_JDialog ( JFrame parent, Command command )
{	super(parent, true);
...
{	__parent_JFrame = parent;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		...
		"where in this case the sample is values at an interval from each time series in the ensemble."),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
...
{	String routine = "NewStatisticTimeSeriesFromEnsemble_JDialog.refresh";
	...
	if ( __first_time ) {
		...
		if (	JGUIUtil.isSimpleJComboBoxItem( __EnsembleID_JComboBox, EnsembleID,
