// SetEnsembleProperty_JDialog extends JDialog - Command editor dialog for the SetEnsembleProperty() command.
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "SetEnsembleProperty");
	}
