// WriteTimeSeriesToHydroJSON_Dialog extends - Command editor dialog for the WriteTimeSeriesToHydroJSON() command.
...
{	Object o = event.getSource();
	...
	if ( o == __browse_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "WriteTimeSeriesToHydroJSON");
	}
...
{	__command = command;
	...
	if ( __working_dir != null ) {
	    ...
	    JGUIUtil.addComponent(file_JPanel, __path_JButton,
	    	7, yFile, 1, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.CENTER);
	}
