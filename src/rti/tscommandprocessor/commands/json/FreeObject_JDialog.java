// FreeObject_JDialog - editor dialog for FreeObject command
...
public class FreeObject_JDialog extends JDialog
...
private FreeObject_Command __command = null;
...
@param objectIDChoices list of object identifiers to provide as choices
*/
public FreeObject_JDialog ( JFrame parent, FreeObject_Command command, List<String> objectIDChoices )
{	super(parent, true);
...
{	Object o = event.getSource();
    ...
    if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "FreeObject");
	}
...
*/
private void initialize ( JFrame parent, FreeObject_Command command, List<String> objectIDChoices )
{	__command = command;
	...
	int yy = -1;
   	...
   	JGUIUtil.addComponent(paragraph, new JLabel (
        "This command frees the specified object, releasing memory so that it can be used by other commands."),
        0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(paragraph, new JLabel (
        "The object will not be available to following " +
    ...
    __ObjectID_JComboBox.setToolTipText("Specify the object to delete, can use ${Property} notation.");
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel( "Required - object to free."), 
