// ConfigureLogging_Command - This class initializes, checks, and runs the Message() command.
...
{	String routine = getClass().getSimpleName() + ".runCommand", message;
	...
	try {
		...
		if ( (StartLogEnabled != null) && !StartLogEnabled.isEmpty() ) {
	        ...
	        try {
	        	processor.setPropContents("StartLogEnabled",Boolean.valueOf(StartLogEnabled));
	    	}
	    	catch ( Exception e ) {
