...
@return the output image file generated by this file
*/
...
@return the output product file generated by this file
*/
...
throws InvalidCommandSyntaxException, InvalidCommandParameterException {
	...
	if ( (command_string.indexOf("=") > 0) || command_string.endsWith("()") ) {
		...
		String TSProductFile = tokens.get(1).trim();
		String RunMode = tokens.get(2).trim();
		String View = tokens.get(3).trim();
		String OutputFile = tokens.get(4).trim();
...
throws InvalidCommandParameterException, CommandWarningException, CommandException {
	...
	try {
    	...
    	if ( isProductTemplate ) {
    		...
    		// - this requires passing processor properties
    		// - the time series product file must have @template because otherwise ${Property} will not be expanded
    		TSProductFile_full = IOUtil.verifyPathForOS(
                IOUtil.toAbsolutePath(TSCommandProcessorUtil.getWorkingDir(processor),
                	TSCommandProcessorUtil.expandParameterValue(processor,this,TSProductFile)) );
...
@param the output image file that is created by this command
*/
...
@param the output product file that is created by this command
*/
