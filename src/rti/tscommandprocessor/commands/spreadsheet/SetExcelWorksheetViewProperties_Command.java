// SetExcelWorksheetViewProperties_Command - This class initializes, checks, and runs the SetExcelWorksheetViewProperties() command, using Apache POI.
	...
	try {
        ...
        if ( wb == null ) {
        	...
        	if ( (Worksheet != null) && (Worksheet.indexOf("*") >= 0) ) {
            	...
            	List<String> worksheetMatchList = new ArrayList<>(); // For matched sheets.
            	List<String> worksheetPatternList = new ArrayList<>(); // Convert * to .* and uppercase for pattern checks.
