...
*/
public WriteTableToExcel_JDialog ( JFrame parent, WriteTableToExcel_Command command )
{	super(parent, true);
...
*/
private void initialize ( JFrame parent, WriteTableToExcel_Command command )
{	__command = command;
    __parent = parent;
