...
private void initialize ( JFrame parent, WriteTimeSeriesToExcel_Command command, List<String> tableIDChoices ) {
    ...
    // TODO SAM 2012-04-10 Evaluate whether the formatter should just be the first part of the format,
    ...
    __ColumnConditionTableID_JComboBox.getJTextComponent().addKeyListener ( this );
    ...
    __ColumnStyleTableID_JComboBox.getJTextComponent().addKeyListener ( this );
    //__TableID_JComboBox.setMaximumRowCount(tableIDChoices.size());
