// MergeTableColumns_Command - handle the MergeTableColumns() command
...
*/
public class MergeTableColumns_Command extends AbstractCommand implements Command
{
...
Constructor.
*/
public MergeTableColumns_Command ()
{	super();
...
{	// The command will be modified if changed...
	return (new MergeTableColumns_JDialog (
		parent, this,
		false	// Not runnable
		)).ok();
}
...
{	String routine = "mergeListFileColumns_Command.runCommand",message = "";
	...
	Message.printStatus ( 2, routine, "Writing table file \"" + OutputFile_full + "\"" );
	try {
	    table.writeDelimitedFile ( OutputFile_full,
			",", // Delimiter
			true, // Write column names
			IOUtil.formatCreatorHeader ( "#", 80, false ), "", // Comments for header
			false, // Don't automatically quote strings
			null, // Do not replace newlines
