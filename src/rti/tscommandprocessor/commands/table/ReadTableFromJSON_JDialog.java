...
{	__command = command;
	...
	JGUIUtil.addComponent(paragraph, new JLabel ("<html><b>This command is under development.  In particular, support for embedded arrays is limited.</b></html>"),
    ...
    JGUIUtil.addComponent(paragraph, new JLabel (
        ...
        0, ++yy, 8, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
        "Top-level ojects can have only one array value that is transferred to the table.  Use ExcludeNames to ignore arrays."),
        0, ++yy, 8, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
