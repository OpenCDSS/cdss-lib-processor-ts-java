// RenameTableColumns_JDialog - editor dialog for RenameTableColumns command
...
public class RenameTableColumns_JDialog extends JDialog
...
private RenameTableColumns_Command __command = null;
...
*/
public RenameTableColumns_JDialog ( JFrame parent, RenameTableColumns_Command command, List<String> tableIDChoices ) {
	super(parent, true);
...
public void actionPerformed(ActionEvent event) {
    ...
    if ( o == __cancel_JButton ) {
        ...
        String [] notes = {
        	"Specify new names for table columns.",
        	"Original Column Name - the original column name (can use ${Property})",
        	"New Column Name - the new column name (can use ${Property})"
    		};
        String dict = (new DictionaryJDialog ( __parent, true, ColumnMap,
            "Edit ColumnMap Parameter", notes, "Original Column Name", "New Column Name",10)).response();
        if ( dict != null ) {
...
*/
private void initialize ( JFrame parent, RenameTableColumns_Command command, List<String> tableIDChoices ) {
	__command = command;
    __parent = parent;
	...
	int yy = -1;
   	...
   	JGUIUtil.addComponent(paragraph, new JLabel (
        "This command renames table columns."),
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel( "Required - table to modify."),
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ("Required - map to change names."),
        3, y, 4, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );
