// SetOutputYearType_JDialog - editor dialog for SetOutputYearType command
...
private SetOutputYearType_Command __command = null;
...
public void actionPerformed( ActionEvent event ) {
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "SetOutputYearType");
	}
