...
private AddConstant_Command __command = null; // Command to edit
...
*/
public AddConstant_JDialog ( JFrame parent, Command command )
{   super(parent, true);
...
{   __command = (AddConstant_Command)command;
