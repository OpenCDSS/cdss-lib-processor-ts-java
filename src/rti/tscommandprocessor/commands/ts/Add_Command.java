...
{	String TSID = parameters.getValue ( "TSID" );
    ...
    */
    ...
    valid_Vector.add ( "AddSpecifiedTSID" );
...
{	String routine = "Add_Command.runCommand", message;
    ...
    String AddSpecifiedTSID = parameters.getValue ( "AddSpecifiedTSID" );
    ...
    try {
        ...
        "\", TSID=\"" + AddTSID + "\", EnsembleID=\"" + AddEnsembleID + "\", SpecifiedTSID=\"" +
        AddSpecifiedTSID + "\") from processor.";
        Message.printWarning(warning_level,
                MessageUtil.formatMessageTag( command_tag, ++warning_count),
                routine, message );
        status.addToLog ( CommandPhaseType.RUN,
...
{	if ( props == null ) {
    ...
    String AddSpecifiedTSID = props.getValue( "AddSpecifiedTSID" );
    ...
    if ( (AddSpecifiedTSID != null) && (AddSpecifiedTSID.length() > 0) ) {
        if ( b.length() > 0 ) {
            b.append ( "," );
        }
        b.append ( "AddSpecifiedTSID=\"" + AddSpecifiedTSID + "\"" );
    }
