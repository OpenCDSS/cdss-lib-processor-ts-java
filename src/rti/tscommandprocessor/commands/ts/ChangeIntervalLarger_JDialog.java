// ChangeIntervalLarger_JDialog - Editor for ChangeIntervalLarger command.
...
/**
 * Editor for ChangeIntervalLarger command.
 * @author sam
 *
 */
...
{		
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Create new time series by changing the data interval of each input time series to a larger interval (e.g., day to month)."),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
    ...
    JGUIUtil.addComponent(analysis_JPanel, __Statistic_JLabel, 
    ...
    JGUIUtil.addComponent(analysis_JPanel, __Tolerance_JLabel,
        0, ++yAnalysis, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    ...
    JGUIUtil.addComponent(analysis_JPanel, new JLabel ( "Optional - convergence tolerance (default = 0.01)."),
	...
	__HandleEndpointsHow_JComboBox.addItemListener ( this );
        JGUIUtil.addComponent(analysis_JPanel, __HandleEndpointsHow_JComboBox,
		1, yAnalysis, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(analysis_JPanel, new JLabel (
    ...
    JGUIUtil.addComponent(analysis_JPanel, __AllowMissingCount_JLabel,
		0, ++yAnalysis, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
	...
	/* TODO SAM 2005-02-18 may enable later
        JGUIUtil.addComponent(analysis_JPanel, new JLabel("Allow missing percent:"),
		0, ++yAnalysis, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
	__AllowMissingPercent_JTextField = new JTextField ( "", 10 );
	JGUIUtil.addComponent(analysis_JPanel, __AllowMissingPercent_JTextField,
		1, yAnalysis, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
	...
	*/
    ...
    JGUIUtil.addComponent(analysis_JPanel, __AllowMissingConsecutive_JLabel,
        0, ++yAnalysis, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    __AllowMissingConsecutive_JTextField = new JTextField ( "", 10 );
    JGUIUtil.addComponent(analysis_JPanel, __AllowMissingConsecutive_JTextField,
        1, yAnalysis, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    ...
    JGUIUtil.addComponent(analysis_JPanel, __OutputFillMethod_JComboBox,
		1, yAnalysis, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(analysis_JPanel, new JLabel (
	...
	__HandleMissingInputHow_JComboBox.addItemListener ( this );
        JGUIUtil.addComponent(analysis_JPanel, __HandleMissingInputHow_JComboBox,
		1, yAnalysis, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(analysis_JPanel, new JLabel (
