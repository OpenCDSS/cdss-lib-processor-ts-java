// ChangeIntervalRegularToIrregular_JDialog - editor dialog for ChangeIntervalRegularToIrregular command
...
public class ChangeIntervalRegularToIrregular_JDialog extends JDialog
	implements ActionListener, DocumentListener, ItemListener, KeyListener, WindowListener
{
// Controls are defined in logical order -- The order they appear in the dialog
// box and documentation.
private ChangeIntervalRegularToIrregular_Command __command = null;// Command object.
...
*/
public ChangeIntervalRegularToIrregular_JDialog ( JFrame parent, ChangeIntervalRegularToIrregular_Command command )
{	
	super(parent, true);
...
*/
private void initialize ( JFrame parent, ChangeIntervalRegularToIrregular_Command command )
{		
	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Create new time series by changing the data interval of each input time series from regular to irregular interval."),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
