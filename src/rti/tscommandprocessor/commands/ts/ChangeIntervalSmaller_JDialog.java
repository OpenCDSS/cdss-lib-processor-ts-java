// ChangeIntervalSmaller_JDialog - editor dialog for ChangeIntervalSmaller command
...
{		
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Create new time series by changing the data interval of each input time series to a smaller interval (e.g., month to day)."),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
