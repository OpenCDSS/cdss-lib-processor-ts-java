// ComputeErrorTimeSeries_JDialog - Editor dialog for the ComputeErrorTimeSeries() command.
...
private ComputeErrorTimeSeries_Command __command = null;
...
*/
public ComputeErrorTimeSeries_JDialog ( JFrame parent, ComputeErrorTimeSeries_Command command )
{   super(parent, true);
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "ComputeErrorTimeSeries");
	}
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, ComputeErrorTimeSeries_Command command )
{   __command = command;
