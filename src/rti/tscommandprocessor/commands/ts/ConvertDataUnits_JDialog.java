// ConvertDataUnits_JDialog - Editor for ConvertDataUnits() command.
...
private ConvertDataUnits_Command __command = null;
...
*/
public ConvertDataUnits_JDialog ( JFrame parent, ConvertDataUnits_Command command )
{   super(parent, true);
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "ConvertDataUnits");
	}
...
*/
private void initialize ( JFrame parent, ConvertDataUnits_Command command )
{   __command = command;
