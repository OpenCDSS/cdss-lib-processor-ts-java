// CreateFromList_Command - This class initializes, checks, and runs the CreateFromList() command.
	...
	try {
        ...
        for ( int i = 0; i < tsize; i++ ) {
            ...
            try {
                ...
                request_params.setUsingObject ( "ReadData", Boolean.valueOf(read_data) );
