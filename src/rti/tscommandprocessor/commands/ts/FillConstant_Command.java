...
throws InvalidCommandParameterException {
    ...
    */
    ...
    validList.add ( "DescriptionSuffix" );
...
throws InvalidCommandSyntaxException, InvalidCommandParameterException {
	...
	if ( (command_string.indexOf('=') > 0) || command_string.endsWith("()") ) {
		...
		// TODO SAM 2005-09-08 This whole block of code needs to be removed as soon as commands have been migrated to the new syntax.
		//
		...
		if ( ntokens != 3 ) {
			...
			message = "Syntax error in legacy command \"" + command_string + "\".  Expecting FillConstant(TSID,Constant).";
...
throws InvalidCommandParameterException, CommandWarningException, CommandException {
    ...
    String DescriptionSuffix = parameters.getValue("DescriptionSuffix");
	if ( commandPhase == CommandPhaseType.RUN ) {
		DescriptionSuffix = TSCommandProcessorUtil.expandParameterValue(processor, this, DescriptionSuffix);
	}
	...
	for ( int its = 0; its < nts; its++ ) {
		...
		try {
			...
			/* TODO SAM 2005-09-08 Might enable this if a MonthlyValues parameter is enabled.
