// FillInterpolate_JDialog - editor dialog for FillInterpolate command
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "FillInterpolate");
	}
...
{	__command = command;
	...
	transChoices.add ( "" );
	transChoices.add ( __command._None );
