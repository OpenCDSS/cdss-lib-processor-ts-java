...
private void initialize ( JFrame parent, FillMOVE2_Command command, List<String> tableIDChoices ) {
    ...
    __IndependentTSID_JComboBox.getJTextComponent().addKeyListener ( this );
	...
	List<String> numeqChoices = new ArrayList<>();
	...
	*/
    ...
    List<String> fillChoices = new ArrayList<>();
    fillChoices.add ( "" );
...
private void refresh () {
	...
	// Regardless, reset the expression from the fields.
	// This is only the visible information and has not yet been committed in the command.
