...
private FillPattern_Command __command = null;// Command as Vector of String
...
*/
public FillPattern_JDialog ( JFrame parent, Command command )
{	super(parent, true);
...
{	__command = (FillPattern_Command)command;
    String routine = "FillPattern_JDialog.initialize";
    ...
    Vector PatternID_List = new Vector();
	...
	"Monthly time series can be filled using historical average" +
