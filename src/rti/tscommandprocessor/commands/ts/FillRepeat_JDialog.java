// FillRepeat_JDialog - editor dialog for FillRepeat command
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "FillRepeat");
	}
...
{   __command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, __FillDirection_JComboBox,
		1, y, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel(
        "Optional - fill direction (default=" + __command._Forward + ")."), 
        3, y, 4, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);

    JGUIUtil.addComponent(main_JPanel,new JLabel( "Max. intervals:"),
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    ...
    __FillFlag_JTextField.setToolTipText("Specify the fill flag string or ${Property} notation");
...
{	String routine = "FillRepeat_JDialog.refresh";
    String TSList = "";
    String TSID = "";
    String EnsembleID = "";
	String FillStart = "";
