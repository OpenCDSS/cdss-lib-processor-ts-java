// LagK_JDialog - editor for LagK command
...
*/
public LagK_JDialog ( JFrame parent, LagK_Command command )
{	super(parent, true);
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "LagK");
	}
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, LagK_Command command )
{	__command = command;
