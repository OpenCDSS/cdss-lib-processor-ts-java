...
{	String AutoExtendPeriod = parameters.getValue ( "AutoExtendPeriod" );
	...
	valid_Vector.add ( "AutoExtendPeriod" );
...
throws InvalidCommandSyntaxException, InvalidCommandParameterException
{
    if ( (command_string.indexOf('=') > 0) || command_string.endsWith("()") ) {
        ...
        if ( ntokens >= 2 ) {
            // Output year type...
            AutoExtendPeriod = ((String)v.elementAt(1)).trim();
        }
...
{	String routine = "SetAutoExtendPeriod_Command.runCommand", message;
	...
	try {
		...
		if ( AutoExtendPeriod.equalsIgnoreCase(_True) ) {
		    ...
		    processor.setPropContents ( "AutoExtendPeriod", new Boolean(true) );
		}
		    ...
		    processor.setPropContents ( "AutoExtendPeriod", new Boolean(false) );
		}
	}
	catch ( Exception e ) {
