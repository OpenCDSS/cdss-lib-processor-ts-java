// SetConstant_JDialog - Editor dialog for the SetConstant() command.
...
public void actionPerformed( ActionEvent event ) {
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "SetConstant");
	}
...
private void checkInput () {
    ...
    if ( SetFlagDescription.length() > 0 ) {
        parameters.set ( "SetFlagDescription", SetFlagDescription );
    }
...
private void initialize ( JFrame parent, SetConstant_Command command ) {
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		...
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"The flag can be set even if numerical values are not specified." ), 
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Required - use for all intervals (if monthly not specified)."),
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel(
		"Optional - flag for values that are set."), 
		3, y, 4, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Set flag description:" ), 
        0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    __SetFlagDescription_JTextField = new JTextField ( 15 );
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Optional - set start (default is all)."),
		3, y, 3, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Optional - set end (default is all)."),
		3, y, 3, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );
