...
{   __command = (SetFromTS_Command)command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		...
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
        "If one indendependent time series is specified, it will be used for all dependent time series."),
        0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
        "If multiple indendependent time series are specified (e.g., for ensembles)," +
