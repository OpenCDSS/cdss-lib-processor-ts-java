// SetTimeSeriesValuesFromLookupTable_JDialog - Editor for the SetTimeSeriesValuesFromLookupTable command.
...
private void initialize ( JFrame parent, SetTimeSeriesValuesFromLookupTable_Command command, List<String> tableIDChoices ) {
    ...
    __InputTSID_JComboBox.getJTextComponent().addKeyListener ( this );
    ...
    __OutputTSID_JComboBox.getJTextComponent().addKeyListener ( this );
    ...
    List<String> lookupChoices = new ArrayList<>();
    lookupChoices.add ( "" );
    ...
    List<String> rangeChoices = new ArrayList<>();
    rangeChoices.add ( "" );
    ...
    List<String> notifyChoices = new ArrayList<>();
    notifyChoices.add ( "" );
    ...
    List<String> transChoices = new ArrayList<>();
    transChoices.add ( "" );
