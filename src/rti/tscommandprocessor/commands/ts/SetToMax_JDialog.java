// SetToMax_JDialog - editor dialog for SetToMax command
...
private SetToMax_Command __command = null;
...
*/
public SetToMax_JDialog ( JFrame parent, Command command )
{	super(parent, true);
...
{	Object o = event.getSource();
	...
	if ( o == __cancel_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "SetToMax");
	}
...
{	__command = (SetToMax_Command)command;
    ...
    JGUIUtil.addComponent(main_JPanel,
		new JLabel ( "Set the time series data values to the maximum of itself and one or " +
...
{   String routine = "SetToMax_JDialog.refresh";
    String TSID = "";
    //String EnsembleID = "";
