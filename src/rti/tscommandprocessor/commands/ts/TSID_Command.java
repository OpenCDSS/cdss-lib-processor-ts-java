...
These are TS objects but with only the metadata (TSIdent) filled in.
*/
	...
	try {
        ...
        if ( ts == null ) {
            if ( !notFoundLogged ) {
                ...
                // This is kind of ugly because currently there is not consistency between all time series readers in error handling,
            	// which is difficult to handle in this generic command.
