// WriteTimeSeriesPropertiesToFile_JDialog - Command editor dialog for the WriteTimeSeriesPropertiesToFile() command.
...
private WriteTimeSeriesPropertiesToFile_Command __command = null;
...
*/
public WriteTimeSeriesPropertiesToFile_JDialog ( JFrame parent, WriteTimeSeriesPropertiesToFile_Command command )
{	super(parent, true);
...
{	Object o = event.getSource();
	...
	if ( o == __browse_JButton ) {
		...
		if (fc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			if (path != null) {
				...
				try {
					...
					Message.printWarning ( 1,"WriteTimeSeriesPropertiesToFile_JDialog", "Error converting file to relative path." );
				}
		...
		HelpViewer.getInstance().showHelp("command", "WriteTimeSeriesPropertiesToFile");
	}
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, WriteTimeSeriesPropertiesToFile_Command command )
{	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Write one or more time series properties to a file.  This is useful for automated software testing." ),
