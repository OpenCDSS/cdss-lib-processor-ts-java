// ----------------------------------------------------------------------------
// setInputPeriod_JDialog - editor for setInputPeriod()
// ----------------------------------------------------------------------------
// Copyright:	See the COPYRIGHT file.
// ----------------------------------------------------------------------------
// History: 
//
// 2002-03-30	Steven A. Malers, RTi	Initial version.  Copy and update
//					setOutputPeriod_Dialog.
// 2002-12-06	SAM, RTi		Update to Swing.
// 2005-09-28	SAM, RTi		Fix minor typo in notes.
// 2005-12-14	SAM, RTi		Change name of class from setQueryPeriod
//					to setInputPeriod and convert to a
//					command class.
...
{	__command = (setInputPeriod_Command)command;
	...
	// Main contents...
		...
		" command may result in incomplete data being available for " +
		"data filling."),
		0, ++y, 6, 1, 0, 0, insetsMin, GridBagConstraints.NONE, GridBagConstraints.WEST);
