...
/**
Editor for he ReadUsgsNwisGroundwater() command.
*/
public class ReadUsgsNwisGroundwater_JDialog extends JDialog
...
*/
public ReadUsgsNwisGroundwater_JDialog ( JFrame parent, ReadUsgsNwisGroundwater_Command command )
{	super(parent, true);
...
private void checkGUIState()
{
    ...
    UsgsNwisGroundwaterDataStore dataStore = getSelectedDataStore();
    if ( dataStore != null ) {
...
{   String routine = getClass().getName() + ".getSelectedDataStore";
    String DataStore = __DataStore_JComboBox.getSelected();
    UsgsNwisGroundwaterDataStore dataStore = (UsgsNwisGroundwaterDataStore)((TSCommandProcessor)
        __command.getCommandProcessor()).getDataStoreForName(
        DataStore, UsgsNwisGroundwaterDataStore.class );
    if ( dataStore == null ) {
        Message.printStatus(2, routine,
            "Unable to get selected data store \"" + DataStore + "\" from processor." );
    }
    return dataStore;
}
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, ReadUsgsNwisGroundwater_Command command )
{	//String routine = "ReadUsgsNwisGroundwater_JDialog.initialize";
	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
    	"Read one or more time series from the USGS NWIS groundwater (historical manually recorded values) web service."),
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
        ...
        0, ++yMain, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
        "<html><b>Daily time series are created - in the future other data intervals may be supported.</b></html>"),
        0, ++yMain, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
        ...
        0, ++yMain, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
        "Refer to the USGS NWIS Groundwater Datastore documentation for more information." ), 
        0, ++yMain, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(main_JPanel, new JLabel (
    ...
    List<DataStore> dataStoreList = tsProcessor.getDataStoresByType( UsgsNwisGroundwaterDataStore.class );
