...
/**
This class is an input filter for querying USGS NWIS instantaneous web services.
*/
public class UsgsNwisInstantaneous_TimeSeries_InputFilter_JPanel extends InputFilter_JPanel //implements ItemListener, KeyListener
{
...
*/
public UsgsNwisInstantaneous_TimeSeries_InputFilter_JPanel( UsgsNwisInstantaneousDataStore dataStore, int numFilterGroups )
{   super();
...
@return the data store corresponding to this input filter panel.
*/
public UsgsNwisInstantaneousDataStore getDataStore ( )
{
    return __dataStore;
}
