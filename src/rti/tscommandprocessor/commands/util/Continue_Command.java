// Continue_Command - This class initializes, checks, and runs the Continue() command.
...
/**
This class initializes, checks, and runs the Continue() command.
*/
public class Continue_Command extends AbstractCommand
{

/**
Constructor.
*/
public Continue_Command ()
{	super();
	setCommandName ( "Continue" );
}
...
{	// The command will be modified if changed...
	return (new Continue_JDialog ( parent, this )).ok();
}
