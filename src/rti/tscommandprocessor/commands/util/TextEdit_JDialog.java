// TextEdit_JDialog - editor for TextEdit command
...
public class TextEdit_JDialog extends JDialog
...
private TextEdit_Command __command = null;
...
{	Object o = event.getSource();
    ...
    if ( o == __browseOutput_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "TextEdit");
	}
...
{	String routine = getClass().getSimpleName() + ".refresh";
	...
	if ( __first_time ) {
		...
		if ( SearchFor != null ) {
			__SearchFor_JTextField.setText ( SearchFor );
		}
		if ( ReplaceWith != null ) {
