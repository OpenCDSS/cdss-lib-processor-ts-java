...
{	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"<html><b>This command has been replaced by WritePropertiesToFile() command and may be removed in the future.</b></html>" ),
	...
	__PropertyName_JComboBox.setData ( new Vector<String>(TSCommandProcessorUtil.getPropertyNameList(processor)) );
