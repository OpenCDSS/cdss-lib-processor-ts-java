...
{	String OutputFile = parameters.getValue ( "OutputFile" );
	...
	if ( (Version != null) && !Version.equals("") && !Version.equals(_WaterML1_1)) {
        message = "The version \"" + Version + "\" must be blank or " + _WaterML1_1;
        warning += "\n" + message;
        status.addToLog ( CommandPhaseType.INITIALIZATION,
                new CommandLogRecord(CommandStatusType.FAILURE,
                        message, "Specify the version as blank or " + _WaterML1_1 + "." ) );
	}
...
{	String routine = "WriteWaterML_Command.runCommand", message;
	int warning_level = 2;
