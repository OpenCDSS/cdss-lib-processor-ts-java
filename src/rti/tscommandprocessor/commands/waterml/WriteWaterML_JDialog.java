// WriteWaterML_JDialog - Command editor dialog for the WriteWaterML() command.
...
/**
Command editor dialog for the WriteWaterML() command.
*/
@SuppressWarnings("serial")
public class WriteWaterML_JDialog extends JDialog
...
{	Object o = event.getSource();
	...
	if ( o == __browse_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "WriteWaterML");
	}
...
{	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ("WaterML version:"),
        0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    ...
    JGUIUtil.addComponent(main_JPanel, __Version_JComboBox,
        ...
        JGUIUtil.addComponent(main_JPanel, new JLabel ("Optional - WaterML version (default=most recent supported)."),
...
{	String routine = "WriteWaterML_JDialog.refresh";
	String OutputFile = "";
	String Version = "";
	String Precision = "";
	String MissingValue = "";
